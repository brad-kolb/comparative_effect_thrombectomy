...
When taken together with the estimates for the average relative treatment effects, these estimates of trial-specific treatment effect heterogeneity can be used to calculate the expected relative treatment effect of thrombectomy in a new trial.
```{r}
#| echo: false
(
  df <- varying_summary %>% 
