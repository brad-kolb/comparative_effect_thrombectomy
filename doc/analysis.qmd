...
The main estimands were the risk ratio (chance of functional independence in treatment group / chance of functional independence in control group) and risk difference (chance of functional independence in treatment group - chance of functional independence in control group). Functional independence was defined as a score of 0 to 2 on the modified Rankin scale at 90 days. Each estimand was adjusted for stroke type. Results were presented as posterior median and 95% posterior intervals (PI). 
