...
These values correspond to an estimated `r comma((exp(df$median) - 1)*100)`% average improvement in the odds of functional independence at 90 days with thrombectomy (95% CI `r comma((exp(df$low) - 1)*100)`% to `r comma((exp(df$high) - 1)*100)`%). The expected effect of thrombectomy on 90 day functional independence in the next early stroke trial is shown in the following table.
...
The probability of thrombectomy improving the odds of functional independence at 90 days in a new trial was estimated to be `r comma(df$prob_pos*100)`%.
