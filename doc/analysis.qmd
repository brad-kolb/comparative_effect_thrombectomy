...
The average relative effect of thrombectomy on chance of functional independence for large core stroke trials was `r median1` (`r low1` - `r high1`) compared to `r median2` (`r low2` - `r high2`) for small core stroke trials, `r median3` (`r low3` - `r high3`) for extended window stroke trials, and `r median4` (`r low4` - `r high4`) for basilar stroke trials.
...
The average absolute effect of thrombectomy on chance of functional independence for large core stroke trials was `r median1`% (`r low1`% - `r high1`%) compared to `r median2`% (`r low2`% - `r high2`%) for small core stroke trials, `r median3`% (`r low3`% - `r high3`%) for extended window stroke trials, and `r median4`% (`r low4` - `r high4`%) for basilar stroke trials.

![](images/risk_difference.pdf){width="7in" height="5in"}
