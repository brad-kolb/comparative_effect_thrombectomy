...
Effect sizes from each of the stroke trials are shown here, with $y$ representing the observed treatment effect of thrombectomy (the odds ratio on the log scale) and $\text{se}$ representing the standard error for $y$.
...
The estimated average treatment effect of thrombectomy across trials for each stroke type is shown below.
...
For early stroke, the plotted values correspond to an estimated `r comma((exp(df$median) - 1)*100)`% average improvement in the odds of functional independence at 90 days with thrombectomy (95% CI `r comma((exp(df$low) - 1)*100)`% to `r comma((exp(df$high) - 1)*100)`%). The probability that the effect is positive is `r comma(df$prob_pos*100)`%.
...
For large stroke, the plotted values correspond to an estimated `r comma((exp(df$median) - 1)*100)`% average improvement in the odds of functional independence at 90 days with thrombectomy (95% CI `r comma((exp(df$low) - 1)*100)`% to `r comma((exp(df$high) - 1)*100)`%). The probability that the effect is positive is `r comma(df$prob_pos*100)`%.
...
For late stroke, the plotted values correspond to an estimated `r comma((exp(df$median) - 1)*100)`% average improvement in the odds of functional independence at 90 days with thrombectomy (95% CI `r comma((exp(df$low) - 1)*100)`% to `r comma((exp(df$high) - 1)*100)`%). The probability that the effect is positive is `r comma(df$prob_pos*100)`%.
...
For basilar stroke, the plotted values correspond to an estimated `r comma((exp(df$median) - 1)*100)`% average improvement in the odds of functional independence at 90 days with thrombectomy (95% CI `r comma((exp(df$low) - 1)*100)`% to `r comma((exp(df$high) - 1)*100)`%). The probability that the effect is positive is `r comma(df$prob_pos*100)`%.
...
The anticipated treatment effect of thrombectomy in a hypothetical new trial for each stroke type is shown below.
